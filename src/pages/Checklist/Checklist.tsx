...
const determineIfAllAreCheckedOrNA = (
  ...
  return (
    checkItemsToDetermine.every((item) => item.isOk || item.isNotApplicable) &&
  ...
  useEffect(() => {
    (async (): Promise<void> => {
      try {
        ...
        setIsVerified(!!checklistResponse.checkList.verifiedByFirstName);
      ...
      <>
        ...
        {isVerified && (
          <Banner>
            ...
            <Banner.Message>This checklist is verified.</Banner.Message>
          </Banner>
        )}
        {checklistDetails && (
          <ChecklistWrapper>
            ...
            <AttachmentsWrapper>
              <Attachments
                getAttachments={(): Promise<Attachment[]> =>
                  api.getChecklistAttachments(params.plant, params.checklistId)
                }
